...
export class GraphicsComponent implements OnInit {
  ...
  constructor(private titleService: Title, private names: ComponentNamesService, seoService: SeoService, private meta: Meta) {
    ...
    this.meta.updateTag({property:'og:url', content:'https://www.vagart.pl/grafika'});
